...
class VcMod(commands.Cog):
    ...
    async def block(self, ctx, member: discord.Member):
        ...
        "**WARNING:** For this command to work, you must **FIRST** run `t@score` to remove all of the user's points from the tatsu bot. (Use the “Penalize user score” option.) "
        "Otherwise tatsu will give them access again! "
